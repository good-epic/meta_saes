...
class AutoInterpreter:
    def __init__(self, feature_statistics, model, dataset):
    ...
    def get_feature_summary(self, feature_idx):
        ...
        top_examples = self.stats.get_top_examples(feature_idx, self.model, self.dataset, top_k=10, pre_context=4, post_context=2)
    ...
    def interpret_feature(self, feature_idx):
        ...
        prompt = f"The following text snippets have something in common, provide a short but specific description (less than 5 words) of what this is. What specific words/properties/topics/sounds do these examples have in common?:\n\n{summary}"
