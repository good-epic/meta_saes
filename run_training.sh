...
#
# Usage:
#   ./run_training.sh              # Run with defaults
#   ./run_training.sh --dry-run    # Print command without running
#
# =============================================================================
...
# Training budget
NUM_TOKENS=100_000_000     # 100M tokens (adjust based on compute budget)
...
# Output paths
JOINT_PRIMARY_PATH="joint_primary_sae.pt"
JOINT_META_PATH="joint_meta_sae.pt"
SOLO_PRIMARY_PATH="solo_primary_sae.pt"
SEQUENTIAL_META_PATH="sequential_meta_sae.pt"
